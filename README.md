...
```java
package com.ob.rpc.sample.server;

import com.ob.rpc.sample.api.HelloService;
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <context:component-scan base-package="com.ob.rpc.sample.server"/>
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <!-- Service Discovery -->
    <bean id="serviceDiscovery" class="com.ob.rpc.registry.zookeeper.ZooKeeperServiceDiscovery">
        <constructor-arg name="zkAddress" value="${rpc.registry_address}"/>
    </bean>

    <!-- RPC Proxy -->
    <bean id="rpcProxy" class="com.ob.rpc.client.RpcProxy">
