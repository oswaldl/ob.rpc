package com.ob.rpc.server;

import com.ob.rpc.common.bean.RpcRequest;
import com.ob.rpc.common.bean.RpcResponse;
import com.ob.rpc.common.codec.RpcDecoder;
import com.ob.rpc.common.codec.RpcEncoder;
...
public class RpcServer implements ApplicationContextAware, InitializingBean {
    ...
    /**
     * 把当前war里面的spring配置的服务放到handlerMap
     * @param ctx
    ...
    /**
     * 1. 启动nio服务器,并注册请求处理类(处理类中含有handlerMap)
     * 2. 把handlerMap信息写到zookeeper当中
     * @throws Exception
     */
    @Override
